...
- READ THE CAPTURED FRACTION FROM positionManagement[].pnlPctOfMax — it is server-computed, sign-correct, and unit-correct (0.50 = 50% captured, 1.00 = max profit reached). Mention the captured % explicitly in the rationale.
